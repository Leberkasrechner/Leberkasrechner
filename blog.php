...
<?php else : ?>
    ...
    <div class="comments-section mt-4">
        ...
        <!-- Kommentare anzeigen -->
        <?php
        $stmt = $conn->prepare("SELECT `id`, `blog_post_id`, `author`, `comment`, `created_at`, `is_approved` FROM blog_comments WHERE blog_post_id = ? AND is_approved = 1 ORDER BY created_at DESC");
